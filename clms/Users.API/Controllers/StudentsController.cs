...
namespace Users.API.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        public StudentsController(IReadRepository<Student> readRepository, IWriteRepository<Student> writeRepository, IMapper<Student, StudentDto> mapper, IMapper<Student, StudentCreateDto> createMapper)
        {
